    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 py-32 lg:py-40">
        <div className="max-w-3xl">
          ...
          >
            Reducimos tus costos operativos, mejoramos la retención de clientes y 
            ofrecemos atención 24/7 con tecnología omnicanal. Somos la inversión 
            estratégica que tu empresa necesita para escalar.
          </motion.p>
