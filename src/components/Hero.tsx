      ...
      <div className="container mx-auto relative z-10 py-32 lg:py-40">
        <div className="max-w-3xl">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-primary-foreground/75 mb-10 max-w-2xl leading-relaxed">Reducimos tus costos operativos, eliminamos tus contingencias laborales y potenciamos la productividad de tu equipo. Ofrecemos atención 24/7 con tecnología omnicanal. Somos la inversión estratégica que tu empresa necesita para escalar.
